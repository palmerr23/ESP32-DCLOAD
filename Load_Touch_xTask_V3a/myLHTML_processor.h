...
#define MYLHTTPX_H
//#include <sstream>
#define JSON_STR_SIZE 4096
char JSONstring[JSON_STR_SIZE];
char currentWebScreen = 'M'; // start with iNput screen
char xbuf[64];

#define NUMSCREENS 3
// MAIN, STEP, LOG
char screenNames [NUMSCREENS][8] = {"Main","Step", "Log"}; // goes on the button and in headline
char screenList[NUMSCREENS] = {'M','S','L'}; // actual reference
...
String knobBlock(void)
{
  ...
  {
    // Kelvin mode buttons
    html += "<div id =\"DKA\" class=\"divs\"><label id =\"LKA\" class=\"spad\" >";
      html += "<input type=\"checkbox\" id=\"KA\" name=\"NKAV\" class=\"btns\" onclick=\"clickDiv(this)\"/><span id =\"SKA\" class=\"btnsz\">Auto</span></label></div> "; // KA but 
    html += "<div id =\"DKM\" class=\"divs\"><label id =\"LKM\" class=\"spad\" >";
      html += "<input type=\"checkbox\" id=\"KM\" name=\"NKMV\" class=\"btns\" onclick=\"clickDiv(this)\"/><span id =\"SKM\" class=\"btnsz\">Main</span></label></div> "; // KM but 
    html += "<div id =\"DKK\" class=\"divs\"><label id =\"LKK\" class=\"spad\" >";
      html += "<input type=\"checkbox\" id=\"KK\" name=\"NKKV\" class=\"btns\" onclick=\"clickDiv(this)\"/><span id =\"SKK\" class=\"btnsz\">Kel</span></label></div><BR><BR>"; // KK but 
}   
	 //KNOB - attaches to last selected setting
	 html += "<div id=\"jog_dial\" style=\"height:110px; width:110px; margin-left: auto; margin-right: auto;\"></div>"; //class=\"dialX\" 
     //000.00 buttons	
	...
	html += "<input type=\"text\" hidden id=\"dialVal\" value=0 size=1> ";	// hide when not needed - code uses them
	 ...
	 html += "<input type=\"text\" maxlength=\"16\" class=\"errline\" readonly name=\"input_error\" id=\"input_errorID\" value =\" \" style=\"color: red;\" size=\"9\"><BR>\n"; 
...
String modeButtonsB(void)
{
	...
	html += "<div style=\" position: relative; display: table-cell; float: left; width: 70px;\">&nbsp;</div>"; // SPACER
	...
	html += "<div style=\" position: relative; display: table-cell; float: left; width: 20px;\">&nbsp;</div>"; // SPACER
